    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <View style={styles.quantidadeContainer}>
          <TouchableOpacity
            style={[styles.qtdBotao, quantidade === 1 && styles.qtdBotaoDisabled]}
            onPress={diminuir}
...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  nome: { fontSize: 24, fontWeight: "700", marginBottom: 10, color: "#333" },
  descricao: { fontSize: 16, color: "#555", lineHeight: 22, marginBottom: 20 },
  preco: { fontSize: 22, fontWeight: "700", color: "#EA1D2C" },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: "#eee", backgroundColor: "#fff" },
  quantidadeContainer: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginBottom: 12 },
  qtdBotao: { width: 36, height: 36, borderRadius: 18, borderWidth: 1, borderColor: "#EA1D2C", alignItems: "center", justifyContent: "center" },
  ...
  botaoAdd: { backgroundColor: "#EA1D2C", paddingVertical: 14, borderRadius: 8, alignItems: "center" },
